...
public class InterpolationSkeletonsOld : MonoBehaviour
{
    #region Variables
    ...
    void Start()
    {
        ...
        // Skin the mesh for a given skeleton - TODO: FIX ARTIFACTS
        SkinningVisibleUpperBody();
    }
    ...
    private void RetrieveBones()
    {
        ...
        variableUpperBones = setSkeletons.interpolatedUpperBones;
    ...
    void Update()
    {
        ...
        // We also blend the red physical skeleton - EXPERIMENTAL
