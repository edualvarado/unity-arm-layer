...
namespace CustomRagdoll
{
    ...
    */
    ...
    [System.Serializable]
    public class BoneDataElement<DATATYPE>
    {
    ...
    [System.Serializable]
    public class BoneData<BONE_DATA_ELEMENT_TYPE, DATATYPE> where BONE_DATA_ELEMENT_TYPE : BoneDataElement<DATATYPE>, new()
    {
...
#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof(BoneDataAttribute))]
    public class BoneDataAttributeDrawer : PropertyDrawer
    {
