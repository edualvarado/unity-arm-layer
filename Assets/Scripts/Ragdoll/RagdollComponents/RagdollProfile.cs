...
namespace CustomRagdoll
{
    ...
    */
    ...
    [System.Serializable]
    public class RagdollProfileBoneData : BoneData<RagdollProfileBoneDataElement, RagdollProfile.BoneProfile>
    {
    ...
    public class RagdollProfile : ScriptableObject
    {
        ...
        [BoneData]
        public RagdollProfileBoneData boneData = new RagdollProfileBoneData(
...
#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof(RagdollProfile.BoneProfile))]
    public class RagdollProfileBoneProfileDrawer : PropertyDrawer
    {
        ...
        static void DrawPropertiesBlock(SerializedProperty property, Rect position, float _x, ref float y, string shownProp, string label, string[] names)
        {//, ref bool show) {
